...
Partial Public Class GridCheckMarksSelectionxx
    Protected _view As AdvBandedGridView
    Protected selection As ArrayList
    Private column As BandedGridColumn
    ...
    Public Sub New(ByVal view As AdvBandedGridView)
        ...
        Me.View = view
    End Sub
    Public Property View() As AdvBandedGridView
        Get
            Return _view
        End Get
        Set(ByVal value As AdvBandedGridView)
        ...
        End Set
    End Property
    Public ReadOnly Property CheckMarkColumn() As BandedGridColumn
        Get
            Return column
        End Get
    End Property
    ...
    Protected Overridable Sub Attach(ByVal view As AdvBandedGridView)
        ...
        Try
            ...
            column = CType(view.Columns.Add(), BandedGridColumn)
            view.Bands(0).Columns.Add(column)
            column.ColVIndex = 0
    ...
    Private Sub view_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs)
        If View.FocusedColumn.FieldName = column.FieldName OrElse e.KeyCode <> Keys.Space Then
            Return
        End If
