...
Public Class UserControl3
    ...
    Private Sub LoadEmp()
        Using db As New CsmdBioAttendenceEntities
            Dim dt = (From a In db.Employees Where a.Emp_Status = True Order By a.Emp_Name Select New With {.ID = a.Emp_ID, a.Emp_Name, .On = a.Emp_DutyOn, .Off = a.Emp_Duty_Off}).ToList
            If dt.Count > 0 Then
    ...
    Private Sub LoadImportDateCalcu()
        Using db As New CsmdBioAttendenceEntities
            ...
            'ExcelAdp.Fill(dts)
            'ExcelCon.Close()
            Dim DutyOnX As DateTime = CDate(CDate(DutyFri.EditValue).ToString("HH:mm")) ' CDate(CDate(DutyOn.EditValue).ToString("HH:mm"))
            Dim DutyOffX As DateTime = CDate(CDate(DutyFri.EditValue).ToString("HH:mm")) ' CDate(CDate(DutyOff.EditValue).ToString("HH:mm"))
    ...
    Private Sub popAddNew_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs)
        frmAttReporstEdit.ShowDialog()
    End Sub

    Private Sub popEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs)
        'GridView1.OptionsBehavior.Editable = True
    End Sub

    Private Sub popDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs)
    ...
    Private Sub RepositoryItemDateEdit3_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles RepositoryItemDateEdit3.ButtonClick
        Select Case e.Button.Index
            Case 1
    ...
    Private Sub Att_Settings(sender As Object, e As EventArgs) Handles DutyFri.EditValueChanged, Sp1.EditValueChanged, Sp2.EditValueChanged, Sp3.EditValueChanged, Sp4.EditValueChanged, Sp5.EditValueChanged
        SaveUpdate_Att_Setting()
    End Sub


    Private Sub BarButtonItem19_ItemClick_1(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem19.ItemClick
